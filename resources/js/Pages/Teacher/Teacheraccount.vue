        ...
        <div class="content">
                        ...
                        >
                            ...
                            <div class="p-6 flex flex-col justify-start">
                                ...
                                <p
                                    ...
                                    v-if="teacher.interviewstatus != 'accepted'"
                                >
                                ...
                                <p class="text-gray-600 text-xs">
                                    <span><b>Interview Link: </b></span
                                    >{{ teacher.interviewlink }}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div v-if="questions.length > 0">
                <div
                    ...
                    v-if="teacher.teststatus != 'accepted'"
                >
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow">
                    ...
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            ...
                            <div>
                                <label for="degree" class="sr-only"
                                    >Degree</label
                                >
                                <input
                                    ref="degree"
            ...
            <div v-if="teacher.interviewstatus == 'accepted'">
                <div class="bg-white shadow">
                    ...
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <div>
                                <label for="classname" class="sr-only"
                                    >classname</label
                                >
                                <input
                                    id="classname"
                            ...
                            <div>
                                <label for="classbio" class="sr-only"
                                    >classbio</label
                                >
                                <input
                                    id="classbio"
                                    ...
                                    v-model="classdetail.bio"
                                />
                            </div>
                            <div>
                                <label for="classesperweek" class="sr-only"
                                    >classesperweek</label
                                >
                                <input
                                    id="classesperweek"
                                    name="classesperweek"
                                    ...
                                    v-model="classdetail.classesperweek"
                                />
                            </div>
                            <div>
                                <label for="totalclasses" class="sr-only"
                                    >totalclasses</label
                                >
                                <input
                                    id="totalclasses"
                                    ...
                                    v-model="classdetail.totalclasses"
                                />
                            </div>
                            <div>
                                <label for="monthlyfees" class="sr-only"
                                    >monthlyfees</label
                                >
                                <input
                                    id="monthlyfees"
                                    ...
                                    v-model="classdetail.monthlyfees"
                                />
                            </div>
                            <div>
                                <button
            ...
            <div
                class="bg-white shadow"
                v-if="teacher.degreestatus != 'accepted'"
            >
                <div class="max-w-7xl mt-10 mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex flex-wrap justify-between">
                        ...
                        >
                            <div
                                v-if="classroom.status == 'accepted'"
                            ...
                            >
                                ...
                                <div class="p-5">
                                    <a :href="'getclassroom/' + classroom.id">
                                        <h5
                                    ...
                                    >
                                        classes per week:
                                        {{ classroom.classesperweek }}
                                    </p>
                                    <p
                                        class="mb-3 font-normal text-gray-700 dark:text-gray-400"
                                    >
                                        Monthly Fees:
                                        {{ classroom.monthlyfees }}
                                    </p>
                                    <p
                                        class="mb-3 font-normal text-gray-700 dark:text-gray-400"
                                    >
                                    ...
                                    <div class="flex">
                                        <a
                                            @click="approveclass(classroom.id)"
