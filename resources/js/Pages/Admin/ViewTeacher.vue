<template>
    <div>
        ...
        <div class="content">
                ...
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-center">
                        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                            <img class="w-full h-60 object-cover w-48 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                :src="
            ...
            <div class="bg-white shadow">
                <div class="mt-10 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between">
                ...
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <div class="flex">
                        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg mr-10">
                            <img class="w-full h-60 object-cover w-96 rounded-t-lg md:rounded-none md:rounded-l-lg"
                                :src="
                                    'http://localhost:8001/Storage/' +
                                    teacher.idfront
                                " alt="" />
            ...
            <div class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <form class="mt-8 space-y-6 myform max-w-2xl" @submit.prevent="createQuestion">
                        <div>
                            ...
                            <input id="question" name="question" type="text" required=""
                                ...
                                placeholder="Write Question" v-model="question" />
                        </div>
                ...
                <div class="max-w-7xl mt-10 mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    ...
                    <div v-for="(question, itemObjKey) in questions" :key="question.id">
                        <div class="rounded-md shadow-sm -space-y-px mt-10">
                            ...
                            <div>
                                <p class="text-base inline-block ml-10">{{ question.answer }}</p>
                            </div>
                        </div>
                    </div>
                </div>
